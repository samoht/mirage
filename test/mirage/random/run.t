Configure the project for Unix:
  ...
  # 25 "lib/mirage/impl/mirage_impl_reporter.ml"
...
Configure the project for Xen:
  ...
  let bootvar__1 = lazy (
  # 22 "lib/mirage/impl/mirage_impl_argv.ml"
    Bootvar.argv ()
  );;
  # 86 "mirage/main.ml"
